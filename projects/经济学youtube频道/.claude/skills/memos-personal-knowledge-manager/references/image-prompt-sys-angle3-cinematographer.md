---
name: Grok Image Prompt — Angle 3: Cinematographer (Hollywood Drama)
description: 电影镜头语言风格。Grok 读取文案片段后输出电影机位式 image prompt，用于 Flow 生成。
---
...
- Specify exact camera angle and lens language: "extreme low-angle worm's-eye view", "over-the-shoulder shot", "Dutch angle tilt", "deep focus foreground-to-background", "rule of thirds".
- Describe scale contrast: how the size relationship between foreground subject and background environment tells the story.
